...
DEFAULT_M_BLOCK_SIZES = [64, 128, 256]
# DEFAULT_N_BLOCK_SIZES = [16, 32, 64, 128, 256]
# DEFAULT_K_BLOCK_SIZES = [16, 32, 64, 128, 256]
DEFAULT_N_BLOCK_SIZES = [16, 64, 128]
DEFAULT_K_BLOCK_SIZES = [16, 64, 128]
DEFAULT_NUM_CTAS = 1
...
def common_prune_criteria(config: triton.Config, kwargs: dict, dtype):
    from unsloth_moe.interface import supports_tma
    from unsloth_moe.kernels.tuning import get_device_properties
